...
/**
 * @swagger
 * /api/v1/staff/bus-trip-revenue/trigger-status-check:
 *   post:
 *     tags:
 *       - Staff | Bus Trip Revenue
...
/**
 * @swagger
 * /api/v1/staff/bus-trip-revenue/config:
 *   get:
 *     tags:
 *       - Staff | Bus Trip Revenue
...
/**
 * @swagger
 * /api/v1/staff/bus-trip-revenue/unsynced:
 *   get:
 *     tags:
 *       - Staff | Bus Trip Revenue
...
/**
 * @swagger
 * /api/v1/staff/bus-trip-revenue/process-unsynced:
 *   post:
 *     tags:
 *       - Staff | Bus Trip Revenue
...
/**
 * @swagger
 * /api/v1/staff/bus-trip-revenue/receivable-payment:
 *   post:
 *     tags:
 *       - Staff | Bus Trip Revenue
...
/**
 * @swagger
 * /api/v1/staff/bus-trip-revenue/{id}:
 *   get:
 *     tags:
 *       - Staff | Bus Trip Revenue
...
/**
 * @swagger
 * /api/v1/staff/bus-trip-revenue/{id}/archive:
 *   patch:
 *     tags:
 *       - Staff | Bus Trip Revenue
...
/**
 * @swagger
 * /api/v1/staff/bus-trip-revenue/{id}/restore:
 *   patch:
 *     tags:
 *       - Staff | Bus Trip Revenue
...
/**
 * @swagger
 * /api/v1/staff/bus-trip-revenue/{id}/permanent:
 *   delete:
 *     tags:
 *       - Staff | Bus Trip Revenue
