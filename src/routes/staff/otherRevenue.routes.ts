/**
 * OTHER REVENUE ROUTES (STAFF)
 * 
 * Routes for other revenue CRUD operations.
 * Base URL: /api/v1/staff/other-revenue
 */
...
/**
 * @swagger
 * /api/v1/staff/other-revenue/types:
 *   get:
...
/**
 * @swagger
 * /api/v1/staff/other-revenue/departments:
 *   get:
...
/**
 * @swagger
 * /api/v1/staff/other-revenue/schedule-frequencies:
 *   get:
...
/**
 * @swagger
 * /api/v1/staff/other-revenue/payment:
 *   post:
...
/**
 * @swagger
 * /api/v1/staff/other-revenue/{id}/approve:
 *   patch:
...
/**
 * @swagger
 * /api/v1/staff/other-revenue/{id}/reject:
 *   patch:
