...
interface AdminExpenseViewModalProps {
  expense: AdministrativeExpense;
  onClose: () => void;
}

const AdminExpenseViewModal: React.FC<AdminExpenseViewModalProps> = ({ expense, onClose }) => {
  ...
  const modalContent = (
    <div className="modalOverlay">
      <div className="modalStandard">
        <ModalHeader
          title={`Administrative Expense - ${expense.invoice_number || expense.id}`}
          onClose={onClose}
        />
        ...
        <div className="modalContent">
          ...
          <div className="formRow">
            <div className="formField">
              ...
              <input type="text" value={expense.department || 'N/A'} readOnly />
            </div>
            <div className="formField">
              <label>Vendor:</label>
              <input type="text" value={expense.vendor || 'N/A'} readOnly />
            </div>
            <div className="formField">
              <label>Invoice Number:</label>
              <input type="text" value={expense.invoice_number || 'N/A'} readOnly />
            </div>
          </div>
        </div>
