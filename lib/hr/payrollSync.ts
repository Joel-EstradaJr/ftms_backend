...
async function syncEmployeePayroll(
  ...
  // Ensure employee exists in employee_local before creating payroll record
  // This prevents foreign key constraint violations
  await prisma.employee_local.upsert({
    where: {
    ...
    create: {
      ...
      middle_name: null,
      last_name: null,
      position: 'Unknown', // Required field - will be updated by HR sync
      department_id: 0,         // Required field - will be updated by HR sync
      department: 'Unknown', // Required field - will be updated by HR sync
      last_synced_at: new Date(),
      is_deleted: false,
    },
  });
